...
PVector trippyBounce(float x, float y)
{
  float xp = x/width;
  float yp = y/height;
...
color getColor(int x, int y)
{
  ...
  return buf.get(round(vec.x * 1280), round(vec.y * 1024));  
}
